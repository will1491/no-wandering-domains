...
-/
import NoWanderingDomains.Dynamics.Sullivan.EventualInjectivity.WindingGrowth

/-!
# The eventual-injectivity package

The fill cannot meet the Julia set cofinally, multiple steps are not cofinal,
and the wandering component eventually maps injectively — the package consumed
by the no-wandering-domains capstone.
-/
